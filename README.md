...
* [Architecture documentation as code with Structurizr and Asciidoctor. Part 4: Publishing](https://blog.codecentric.de/architecture-documentation-as-code-with-structurizr-and-asciidoctor-part4-publishing)
