...
class SystemLandscapeViewTest {

    @TempDir
    private lateinit var tempDir: File

    private val diagramName = "SystemLandscape"
    ...
    fun `landscape diagram is written to plant uml as expected`() {
        ...
        val system0 = model.addSoftwareSystem(
            "Software System 0",
            "Description 0",
            Location.External,
